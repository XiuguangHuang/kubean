...
function func_prepare_config_yaml_kubean_compatibility() {
    ...
    ginkgo -v -timeout=10h -race --focus="Create cluster and all kube-system pods be running"  --fail-fast ./test/kubean_calico_dualstack_e2e/  -- --kubeconfig="${KUBECONFIG_FILE}" \
